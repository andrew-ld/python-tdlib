...
class webPage(Type):
    #  a web page preview @url Original URL of the
...
class getWebPagePreview(Method):
    #  a web page preview by the text of the
    #  Do not call this function too often. Returns a
    #  error if the web page has no preview @text
